...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn("flex items-center w-screen gap-0.5 rounded-lg border ", className)}
      {...props}
    />
  );
}
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center rounded-sm px-1.5 py-0.5 text-sm font-medium outline-hidden select-none  ",
        className,
      )}
      {...props}
    />
